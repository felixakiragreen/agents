...
The work state: the board and the deferred list — a batch's note is its review gate's
doc (`plans/G⟨n⟩-⟨name⟩.md`, its Mission); law in `~/code/agents/canon/work/DOCTRINE.md` §4. Design and agreements live in the master
