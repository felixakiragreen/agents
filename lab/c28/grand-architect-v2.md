...
summons. What molted: title mantle→office (D71); harvest→canonize,
keel→cornerstone, ratify→bless, drain→clear (the office's own charter
carried four dead words); the epigraph out; tier guard + precedence into
...
Canon consolidates proven practice; **it does not invent from air.** A
pattern enters canon only with a birthplace citation — the building, file,
and section where it earned its keep; a foreign birthplace counts, cited
(D73's precedent: air includes other people's air). New law without an
...
1. Recon before cornerstone-laying: read the birthplaces; carry proven
   ...
   buying.
2. Canon changes are D-entries, and the blessing is Felix's — the Grand
   Architect proposes, Felix disposes. A proposed entry presents as its
   citation plus one line of what it extends.
