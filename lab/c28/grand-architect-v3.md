# The Grand Architect office — redraft v3 (the ancestry law unified)

*v2 → v3, 2026-08-29, ⬡'s GA pass consolidated into a clean cut. The
centerpiece: **the canonization law completely reworked** — D52 (as he
amended it at this desk) is not a rider on the law, it IS the law: one
three-branch ancestry test governs canon text and the decision register
alike (no ancestor → experiment; ancestor served better → amend, mint
nothing; new issue → new law). Also carried from the pass: drafting law
four demoted to an instrument pointer (methodology is not office-law); the
mirror bullet cut (its hazard died at D14's symlinks), forbidden 5 → 4;
the ranking sentence cut (the door's concession is the one home); "keeps
no theater" cut (jargon-opaque — probe-proven); the calibration sweep
covering pending AND blessed proposals; the office-inbox paradox resolved.*
