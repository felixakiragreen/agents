...
| 19 | [v3 · doctrine v1.1 — the wave's residue](plans/19-doctrine-hardening.md): 15 evidenced tool defects fold into `doctrine/`, fixtures kept | 17 · Felix-gate: vocabulary countersign — paid 2026-08-28 (D63 2nd amendment + D69 ✓) | Builder · opus-high | OPEN — cut 2026-08-28 (GA-11); holds behind 17's landing: it rewrites the parser 17 is mid-measurement on (§6.7 — the incumbent never molts under a live gauge); fire at 17's landing |
...
| 21 | [the working vocabulary — the standard sitting](plans/21-vocabulary.md): arm / pass / card / flow / verdict / fire / closed / landed / bless / countersign / session / window; subsumes bless-vs-countersign | Felix-gate: his call to sit | Grand Architect · fable-max | OPEN — mandate recorded 2026-08-28 (GA-11) |
