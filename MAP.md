...
| 15 | [Belvedere — the sovereign's glass](belvedere/README.md) (subproject; keel: [plans/belvedere.md](plans/belvedere.md)) | ⬡-gate: venue D2 ✓ Felix via keel §11 | Architect · fable-max (founding) | **IN FLIGHT** — founded 2026-08-26; the campaign runs on its own board, this row is the pointer |
