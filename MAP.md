...
| C35 | [the master-doc purge](plans/c35-map-purge.md) — MAP re-cut with C34's blade: LANDED charges compress to status + findings link, spent batch notes die, dead numbers strip; live holds survive verbatim | C34 | Grand Architect · fable-max | IN FLIGHT — GA-18, 2026-08-29 |
