...
| 16 | [v3 · the doctrine linter](plans/16-doctrine-linter.md) — P3's parsers harden into canon `doctrine/`: `lint` · `parse --json` · `migrate` | — | Builder · opus-high | OPEN — cut 2026-08-26 (D65); dispatchable now, kickoff in the order |
