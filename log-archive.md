...
Whole entries, aged out of [LOG.md](LOG.md) verbatim when the tail outgrew its
budget — the book's physics ride its header. Append-only at the bottom as entries
age in; never edited, never read as protocol. Open it when you want the whole
story; the Shelf in LOG.md carries each seat's marked line forever. Oldest first.
