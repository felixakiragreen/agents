...
*Entries aged out of `SAPHO.md` whole — verbatim, append-only, live. Instantiated
2026-09-06 by mentat-05 at the first aging-out: the tail exceeded six with the neck
sitting, and the founding entry came here first. Read this when the thought needs the
past; the book's head and tail are the orientation, forever.*
