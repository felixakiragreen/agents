...
1. **Spawn architecture (10-F10's four options): option (i) — the setsid-detached
   ...
   invariant, which this charge inherits as law: *no code path may fork the interactive
...
freshness) that this charge is the right desk to decide between — the warm-keeper §1
...
> and the four options are ruled (*The lay*, ruling 1). Closed.
