...
- `./lab/008/run` → the pre-existing environmental failure only (name it), zero others.
...
- The removal arm of the guard proved both ways (green here, red on a pre-029 harness).
