...
**Status:** OPEN — laid 2026-08-29 · **Depends on:** C23 · ⬡-gate: Felix's office/mantle charter drafts · **Staffing:** Grand Architect · fable-max
...
- **The ruled roster (D71):**
  - **Offices** (one holder, a succession, a voice file): **Grand Architect**
    (standards and canon) · **Mentat** (the Sovereign's thinking partner).
...
- **Drafting input, distilled from the inbox (2026-08-28, his words):** sessions
  ...
  me in order to make an informed decision."* The census session decided a spend fork
  twice on gauge data only he holds (wrapped at his "approaching 90%", un-wrapped at
  his "30%"). Candidate line for every charter's escalation triggers: *a
...
- `canon/work/STANDARD.md` §5 (sessions, offices, mantles) · D62 (the Mentat's
  charter physics) · D26 (the null mantle's law).

## Done when:

- Every charter on the ruled roster redrafted with him and blessed ⬡✓.
- Shims match the roster; `canon/mantles/README.md`'s roster is true.
- DECISIONS carries the entry; the standard's §What remains checks off its last step.
