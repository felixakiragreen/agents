...
| C29 | [the summon harness](plans/c29-summon-harness.md) — `lab/08/run` follows `presets.tsv` after the `d dispatcher` retirement; 13-F1's guard gains its removal arm | C25 | Builder · opus-high | OPEN — laid 2026-08-29; **work complete on `bv/c29-summon-harness` @ `f160ec1`, never merged** — flow-1 abandoned (belvedere D22); [G2](plans/g2-c29-merge.md) is the merge gate; master's harness stands 15-red since C25's preset retirement (C25-F3) |
...
| G2 | [c29's merge gate](plans/g2-c29-merge.md) — verify the branch harness FINISHED green, merge `bv/c29-summon-harness`, reconcile C29 | — | Architect · opus-high | OPEN — laid 2026-08-31 (GA-19) |
