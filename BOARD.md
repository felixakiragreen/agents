...
| 044 | [the boot pack](plans/044-boot-pack.md) — `doctrine boot ‹root›`: what a cold session needs, derived from the books at every call, verbatim where it quotes; the law follows at G4 | — | Builder · opus-high | LANDED 2026-09-08 → [findings F1–F6](plans/044-boot-pack.md); `doctrine boot ‹root›` — agents 4.9 KB, stigmergon 4.9 KB, both ≈ 8% of the files a summons named; suite 127 → 139, lint unchanged |
