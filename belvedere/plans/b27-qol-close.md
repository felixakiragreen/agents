...
8. **The worker-env knob** (B23's find, bug-class): a Bun worker never sees
...
9. **The tweak list.** Absorb entries that are visual/QoL/usability within
...
bounded by §9, and this row would rather land small than rule once.
