...
2026-08-28 in the G2 sitting**, formalized at `flow-close`'s card (the
recording sitting writes the final line). **Next-chapter candidates, cut-ready (named
...
a B1-class Felix-run ritual (B14 F1). The chapter beyond them — deck rework
