...
| B23 | [The repaint law](plans/b23-repaint-law.md) — the tenant-listener leak (candidate 6; the verdict-card parity face), the Chat's scroll as repaint-preserved state, the Act-pane stall (candidate 8, hypothesis — reproduce first), the stale board (fourth face: B22–B27 in the wire payload, never painted — measured) | — | Builder · opus-high | OPEN — DEFERRED 2026-08-29 (his v3 word, D19; G4 rules batch 6's fate) |
| B22 | [Hands hygiene](plans/b22-hands-hygiene.md) — trust-flip at cause (candidate 1), the UUID sweep (candidate 2), the b17 probe fix (candidate 3), the audit anchor (candidate 4), the PermissionRequest runbook for Felix's G3 ritual (candidate 5) | B23 | Builder · opus-high | OPEN — DEFERRED 2026-08-29 (his v3 word, D19; G4 rules batch 6's fate) |
| B26 | [Batons on the deck](plans/b26-baton-attention.md) — `attention.ts` gains the baton bucket: Felix-holder ⇒ queue + badge + open-in-composer (never auto-fired, D10), session-holder ⇒ the rail's Dispatch semantics, the Works' landed node says "this landing handed a baton" | B22 | Builder · opus-high | OPEN — DEFERRED 2026-08-29 (his v3 word, D19; G4 rules batch 6's fate) |
| B25 | [Where a fire lands](plans/b25-fire-placement.md) — building-homed workspace placement (name→uuid via B18's read, mint only when none), the fired-for building rides the fire (census join sid→building outranks cwd for glass-fired), minted-workspace retirement | B26 | Builder · opus-high | OPEN — DEFERRED 2026-08-29 (his v3 word, D19; G4 rules batch 6's fate) |
| B24 | [His arrangement](plans/b24-arrangement.md) — the City fully his: reorder, relabel, recolor, nest; persists as `desk/city-arrangement.json`; truth underneath (census decides existence, attention outranks recency inside); candidate 7's verdict (group-first) recorded either way | B25 | Builder · opus-high | OPEN — DEFERRED 2026-08-29 (his v3 word, D19; G4 rules batch 6's fate) |
| B27 | [QoL sweep + close flow](plans/b27-qol-close.md) — the Works' Chat hotswap wired, the honest-disabled law city-wide, the pass gesture findable at flow level, the account knob at compose+arm with all three usage windows labeled (his ruling 2026-08-28), the tweak list absorbed (STOP-clause bounded), `flow-close-6` left unarmed | B24 | Builder · opus-high | OPEN — DEFERRED 2026-08-29 (his v3 word, D19; last: sweeps all batch-6 surfaces) |
| G3 | Rework gate — verify batch 6's landings, fold, sweep ISSUES, cut next; fires by the armed close flow | B27; ⬡-gate: the PermissionRequest ritual + the trust-entry drain + the rework visual pass | Architect · fable-high | OPEN — DEFERRED 2026-08-29 (his v3 word, D19; the inbox sweep + flow-1 findings ride with it) |
...
| V3 | [The v3 campaign](v3/README.md) — the proving ground: substrate + engine from first principles, judged at G4; sub-board within | — | Architect · fable-high | OPEN — cornerstone BLESSED ⬡✓ 2026-08-29 (D19–D21); C4 ignitable |
| C12 | [The transcript mirror](plans/c12-transcript-mirror.md) — append-only byte-true mirror of every account's transcripts + launchd interval + restore drill; the mortal-corpus backstop (v3 C11 F1), his word 2026-08-30 ("Let's do B"); the campaign-scale build stays filed in [ISSUES.md](ISSUES.md) | — | Builder · opus-medium | IN FLIGHT 2026-08-30 — dispatched by the v3 review session at his word; parallel-safe with v3 C8 (read-only overlap); **budget ≤5 subject turns** (the restore drill; ⬡-fork past it, D21) |
