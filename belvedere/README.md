...
arm-gate settled by the exercised fallback; **the deck visual pass and the
chapter verdict remain his** — the batch note closes at his word, and the rooms
may not retire before the pass. **Next-chapter candidates, cut-ready (named
