...
|---|---|---|---|---|
| C11 | [The turn cursor + the real seam](plans/c11-cursor-real-seam.md) — C7 F3's ruled fix (the transcript fallback answers the fired turn, cursor recorded at spawn) + the `{real: …}` subject arm `spawn.ts` reserves | C7 | Builder · opus-high | OPEN — laid 2026-08-30; budget 0 real turns |
