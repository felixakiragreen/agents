...
|---|---|---|---|---|
| C9 | [Scale](plans/c9-scale.md) — bar 5: 100 simultaneous fake through the engine; the real ladder 5 → 10 → 25 (the 25-burst sanctioned by this lay); the cost extrapolation table for G4 | C13 | Digger · opus-medium | OPEN — laid 2026-08-30; **budget ≤$8 and ≤120 turns, dollars lead** (C8 F9; either ceiling a ⬡-fork, D21); ignites first — the engine holds still for its numbers |
