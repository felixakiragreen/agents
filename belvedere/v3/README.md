...
|---|---|---|---|---|
| C9 | [Scale](plans/c9-scale.md) — bar 5: 100 simultaneous fake through the engine; the real ladder 5 → 10 → 25 (the 25-burst sanctioned by this lay); the cost extrapolation table for G4 | C13 | Digger · opus-medium | IN FLIGHT 2026-08-30 — dispatched by the batch-8 tender at his word ("dispatch C9 and then after C10"); **budget ≤$8 and ≤120 turns, dollars lead** (C8 F9; either ceiling a ⬡-fork, D21); the engine holds still for its numbers |
| C10 | [The console demo](plans/c10-console-demo.md) — bar 6: five verbs over the engine's exports (list · read · send · summon · return), scriptable and hand-testable; **step 0: the fallback's pause vocabulary** (C13 F3's deferred two lines) | C13 | Builder · opus-medium | OPEN — laid 2026-08-30; **budget ≤$3 and ≤30 turns**; schedule: after C9 lands (step 0 edits the engine C9 measures — the batch note) |
