...
|---|---|---|---|---|
| G4 | [The verdict](plans/g4-verdict.md) — substrate · v2's fate · migration shape · viewport; convenes on bars 1–6, the pack assembled | C9, C10 | ⬡-gate | OPEN — pack ready 2026-08-30; his hand (`bun belvedere/v3/console/rehearsal.ts personal` + the five verbs) and his four rulings |
