...
| C10 | [The console demo](plans/c10-console-demo.md) — bar 6: five verbs over the engine's exports (list · read · send · summon · return), scriptable and hand-testable; **step 0: the fallback's pause vocabulary** (C13 F3's deferred two lines) | C13 | Builder · opus-medium | IN FLIGHT 2026-08-30 — dispatched by the batch-8 tender on C9's reviewed landing; **budget ≤$3 and ≤30 turns** (either ceiling a ⬡-fork, D21) |
