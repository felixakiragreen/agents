...
| 10 | [summon rig v1.2 — the usage panel](plans/10-summon-rig-v12-usage.md) | 09 LANDED; D41 ✓ 2026-08-07 | Builder · opus-high | **OPEN** — cut 2026-08-07; E2 (the usage source) gates Phase B, Felix at the keyboard for the probe; a documented kill lands the row |
